...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(8, 256, True, (64, 8, 2), id="sm70_split8"),
        pytest.param(8, 512, True, (64, 4, 2), id="sm70_split4"),
        pytest.param(8, 513, False, (64, 1, 2), id="non_sm70_split1"),
        pytest.param(8, 513, True, (64, 1, 4), id="sm70_split1"),
    ],
)
def test_qsa_sparse_launch_profile(
    ...
    assert (
        qsa_ops._qsa_sparse_launch_profile(block_m, base_programs, is_sm70=is_sm70)
        == expected
    )
